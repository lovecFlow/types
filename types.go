...
/* Все данные, хранящиеся в памяти представляют собой набор битов. Тип и определяет какие операции с ними можно производить. Базовые встроенные типы: */ 
...
int: представляет целое число co знаком, которое в зависимости o платформы может занимать либо 4 байта, либо 8 байт. To есть соответствовать либо int32, либо int64.

uint: представляет целое беззнаковое число только без знака, которое, аналогично типу int, в зависимости o платформы может занимать либо 4 байта, либо 8 байт. To есть соответствовать либо uint32, либо uint64.
